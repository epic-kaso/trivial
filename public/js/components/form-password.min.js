...
!function (t) {
    var i;
    jQuery && UIkit && (i = t(jQuery, UIkit)), "function" == typeof define && define.amd && define("uikit-form-password", ["uikit"], function () {
    ...
    return i.component("formPassword", {
        defaults: {lblShow: "Show", lblHide: "Hide"}, boot: function () {
            i.$html.on("click.formpassword.uikit", "[data-@-form-password]", function (t) {
                var e = i.$(this);
                if (!e.data("formPassword")) {
                    t.preventDefault();
                    {
                        i.formPassword(e, i.Utils.options(e.attr("data-@-form-password")))
                    }
                    e.trigger("click")
                }
            })
