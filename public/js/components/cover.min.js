...
!function (t) {
    var i;
    jQuery && UIkit && (i = t(jQuery, UIkit)), "function" == typeof define && define.amd && define("uikit-cover", ["uikit"], function () {
    ...
    i.component("cover", {
        defaults: {automute: !0}, boot: function () {
            i.ready(function (t) {
                i.$("[data-@-cover]", t).each(function () {
                    var t = i.$(this);
                    if (!t.data("cover")) {
                        i.cover(t, i.Utils.options(t.attr("data-@-cover")))
                    }
                })
            })
        }, init: function () {
            if (this.parent = this.element.parent(), i.$win.on("load resize orientationchange", i.Utils.debounce(function () {
                    this.check()
                }.bind(this), 100)), this.on("display.uk.check", function () {
                    this.element.is(":visible") && this.check()
                }.bind(this)), this.check(), this.element.data("cover", this), this.element.is("iframe") && this.options.automute) {
