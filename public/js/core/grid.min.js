        ...
        defaults: {target: !1, row: !0}, boot: function () {
            i.ready(function (t) {
                i.$("[data-@-grid-match]", t).each(function () {
                    var t, n = i.$(this);
                    n.data("gridMatchHeight") || (t = i.gridMatchHeight(n, i.Utils.options(n.attr("data-@-grid-match"))))
                })
            })
        }, init: function () {
            var e = this;
        ...
        defaults: {cls: "@-grid-margin"}, boot: function () {
            i.ready(function (t) {
                i.$("[data-@-grid-margin]", t).each(function () {
                    var t, n = i.$(this);
                    n.data("gridMargin") || (t = i.gridMargin(n, i.Utils.options(n.attr("data-@-grid-margin"))))
                })
            })
        }, init: function () {
