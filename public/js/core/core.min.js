...
!function (t) {
    ...
    "use strict";
    var o = {}, i = window.UIkit;
    if (o.version = "2.15.0", o._prefix = "uk", o.noConflict = function (t) {
            ...
            return e.length ? (["find", "filter", "closest", "attr", "parent", "parents", "children", "addClass", "removeClass", "toggleClass", "hasClass", "is", "on", "one"].forEach(function (n) {
                var i, r = e[n], s = ["find", "filter", "parent", "parents", "children", "closest"];
                return e[n] = function () {
                    for (t = 0; t < arguments.length; t++)"string" == typeof arguments[t] && (arguments[t] = o.prefix(arguments[t]));
                    return i = r.apply(this, arguments), s.indexOf(n) > -1 ? o.$(i) : i
                }, e
            }), e) : e
            ...
            var n, e, o, i, r, s, a, u, c, f;
            t && setTimeout(function () {
                try {
                    for (f = document.styleSheets, i = 0, a = f.length; a > i; i++) {
                        for (o = f[i], e = [], o.cssRules = o.cssRules, n = r = 0, u = o.cssRules.length; u > r; n = ++r)o.cssRules[n].type === CSSRule.STYLE_RULE && t.test(o.cssRules[n].selectorText) && e.unshift(n);
        ...
        var r, s = !1, a = ".@-overlay, .@-overlay-toggle, .@-caption-toggle, .@-animation-hover, .@-has-hover";
        o.$html.on("touchstart MSPointerDown pointerdown", a, function () {
            s && o.$(".@-hover").removeClass("@-hover"), s = o.$(this).addClass("@-hover")
        }).on("touchend MSPointerUp pointerup", function (t) {
            r = o.$(t.target).parents(a), s && s.not(r).removeClass("@-hover")
        })
    }
    return o
});