...
!function (t, i) {
    ...
    i.component("tab", {
        defaults: {
            ...
            if (e.length) {
                var n, s, o = e.eq(0).offset().top + Math.ceil(e.eq(0).height() / 2), a = !1;
                if (this.responsivetab.lst.empty(), e.each(function () {
                        t(this).offset().top > o && (a = !0)
                    }), a)for (var r = 0; r < e.length; r++)n = i.$(e.eq(r)), s = n.find("a"), "none" == n.css("float") || n.attr("@-dropdown") || (n.addClass("@-hidden"), n.hasClass("@-disabled") || this.responsivetab.lst.append('<li><a href="' + s.attr("href") + '" data-index="' + r + '">' + s.html() + "</a></li>"));
